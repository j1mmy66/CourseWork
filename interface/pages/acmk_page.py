...
from interface.describtions.acmk_descroption import ACMK_INFO_MD
...
def build_acmk_page():
    with gr.TabItem("acmk") as uspec_page:
        with gr.Group(elem_classes="custom-card"):
            gr.Markdown("## Кластеризация ACMK", elem_classes="card-title")
